      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="https://docs.google.com/forms/d/e/1FAIpQLSeOnUIctnFYRie_v-0gbTgCPh9MwrgjAwx9z29aH6QrDLUabQ/viewform?usp=sf_link"><span class="subFont"><strong>Feedback</strong></span></a></li>
          ...
          <div class="col-sm-12">
            <div class="jumbotron text-center text-block" style="padding-top:170px;">
              <img src="images/Vote.png" alt="">
                  ...
                  <a href="registration.php" class="btn btn-primary btn-md specialHead"> <span class="glyphicon glyphicon-tag"></span> Registration</a>
                  <a href="logging.php" class="btn btn-primary btn-md specialHead"> <span class="glyphicon glyphicon-tag"></span> Cast Your Vote</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="conatiner" style="padding:50px;" id="aboutTab">
        <div class="row">
          ...
          <div class="col-sm-4 text-center">
            ...
            <p><em>By Providing The Basic Details of Yours and We Will Let You Vote.</em></p>
          ...
          <div class="col-sm-4 text-center">
            ...
            <p><em>The People Or Group/Party that stands in Voting.</em></p>

          </div>
          <div class="col-sm-4 text-center"> 
            
            <img src="images/Stats.png" width="100" height="100" alt=""/>
            <h2 class="normalFont" style="font-size:28px;" >STATISTICS</h2>
            <p><em>SHows You the Final Representation of your Votes In Form Of Result.</em></p>
          ...
          <div class="row">
            <div class="col-sm-12 text-center" style="">
              <div class="page-header" style="padding-top:30px;padding-bottom:30px;">
                ...
                <br>
               <a href="https://docs.google.com/forms/d/e/1FAIpQLSeOnUIctnFYRie_v-0gbTgCPh9MwrgjAwx9z29aH6QrDLUabQ/viewform?usp=sf_link"> <h3><strong>Feedback</strong></h3></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-6 text-center">
             <h3 class="specialHead">Aditya<br>Tushar</h3>
            </div>
            <div class="col-sm-6 text-center">
